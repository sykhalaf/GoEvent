...
public class Mail {
    ...
    public static void main(String args[]) throws AddressException, MessagingException, IOException {
        ...
        mail.draftEmail("rabie.zouita@esprit.tn", "rabie", 500);
        mail.sendEmail();
    }

    public void sendEmail() throws MessagingException {
        String fromUser = "khalaf.sayari@esprit.tn";  //Enter sender email id
        String fromUserPassword = "isikeffrance17";  //Enter sender gmail password , this will be authenticated by gmail smtp server
